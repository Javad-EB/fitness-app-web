                    ...
                    {emailSent ? (
                        <div className="flex justify-center pb-10 w-full">
                            <h2 className="font-semibold text-lg text-center">
                                An email has been sent your way. if you don&lsquo;t see it, please check your spam folder. Just follow the directions in the email to reset your password.
                            </h2>
                        </div>
                    ) : (
