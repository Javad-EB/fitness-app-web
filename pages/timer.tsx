...
const formatSeconds = (seconds: number) => {
    ...
    let sec = Math.floor((seconds % 60) % 60).toString().padStart(2, "0")
...
export default function Timer() {
    ...
    const handleGetStarted = () => {
        ...
        else if (workoutSeconds < 1)
            problems += "Please enter a workout time greater than 0.";
        else if (rounds < 1)
            problems += "Please make timer rounds more than 0";
        if (problems !== "") {
    ...
    return (
        <Page title="Workout Timer" content="Workout timer for your workout.">
                    ...
                    <div>
                        ...
                        <div className="stats shadow">
                            <div className="stat">
                                ...
                                <div className="stat-value text-2xl">{formatSeconds(workoutSeconds)}</div>
                            </div>
                        </div>
                        <div className="stats shadow">
                            <div className="stat">
                                <div className="stat-title">Rest</div>
                                <div className="stat-value text-2xl">{formatSeconds(restSeconds)}</div>
                            </div>
                        </div>
                    </div>
                    <button
            ...
            <div className="flex justify-center pt-20">
                {editWorkout ? (
                    <div>
                        ...
                        <h3 className="text-2xl mb-5">Reset Time</h3>
                        <div className="flex w-96 justify-between mb-10">
                            <Select
                                options={Array.from({ length: 24 }, (_, i) => i)}
                                label="Hours"
                    ...
                    <div>
                        <div>
                            <div className={`radial-progress ${seconds
                                ? roundPeriod === "rest"
                                    ? "text-success"
                                    : "text-primary"
                                : ""
                            ...
                            >
                                {seconds != null ? (
                                    <div className="flex flex-col items-center">
                                        <div className="text-2xl loading-loose">
                                            {formatSeconds(seconds)}
                                        </div>
                                        <p className=" loading-loose font-bold capitalize">
                                            {roundPeriod}
                                        </p>
                                        <p className="loading-loose font-bold">
